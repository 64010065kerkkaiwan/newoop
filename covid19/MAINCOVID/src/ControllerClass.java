...
public class ControllerClass implements Initializable{
    ...
    void ClickClose(ActionEvent event) throws IOException  {
        ...
        if(event.getSource() == btnUsers){
            lblStatusMini.setText("/home/users manual");
            lblStatus.setText("Users Manual");
            pnlStatus.setBackground(new Background(new BackgroundFill(Color.rgb(243, 156, 18),CornerRadii.EMPTY,Insets.EMPTY)));
            new ZoomIn(pnluser).play();
            pnluser.toFront();
        }
